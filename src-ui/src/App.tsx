...
function IconSettings() {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.7 6.5l.8-1.4-1.4-1.4-1.4.8A4 4 0 009 3.8L8.7 2h-2l-.3 1.8a4 4 0 00-1.7.7l-1.4-.8L1.9 5.1l.8 1.4A4 4 0 002.5 8c0 .38.05.75.15 1.1l-.79 1.35 1.41 1.41 1.35-.79c.52.35 1.1.6 1.72.73L6.68 14h2.64l.29-1.2c.62-.13 1.2-.38 1.72-.73l1.35.79 1.41-1.41-.79-1.35A4 4 0 0013.5 8c0-.54-.1-1.06-.27-1.5h-.53z"
        stroke="currentColor"
        strokeWidth="1.2"
...
function IconDict() {
  return (
    ...
    >
      <path
        d="M4 2h7a1 1 0 011 1v10a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1z"
        stroke="currentColor"
        strokeWidth="1.3"
      />
      <path
...
function IconShield() {
  return (
    ...
    >
      <path
        d="M8 1.5L2.5 3.5v4c0 3 2.3 5.3 5.5 6.5 3.2-1.2 5.5-3.5 5.5-6.5v-4L8 1.5z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
export default function App() {
  const [showOnboarding, setShowOnboarding] = useState(
    () => localStorage.getItem("whisp_onboarding_done") !== "1",
  );
    ...
    <div className="app">
      ...
      <nav className="sidebar">
        ...
        <div className="sidebar-nav">
          ...
          <button
            className={`nav-item ${tab === "permissions" ? "active" : ""}`}
                  ...
                  <div className="row-control">
                    <select
                      ...
                      onChange={(e) =>
                        setConfig({
                          ...config,
                          provider: e.target.value as AppConfig["provider"],
                        })
                      }
                    >
              ...
              <div className="section-group">
                ...
                <div className="model-catalog">
                  {models.map((m) => {
                    ...
                    const isActive =
                      !!config.local_whisper_model_path?.includes(m.filename);
                      ...
                      >
                        ...
                        <div className="model-action">
                          ...
                          {isDownloaded && !isActive && (
                            <button
                              className="btn-secondary"
                              onClick={() => selectDownloadedModel(m)}
                            >
                              Use
                            </button>
                          )}
                ...
                <div className="settings-row">
                  ...
                  <div className="row-control">
                    <Toggle
                      ...
                      onChange={(v) =>
                        setConfig({ ...config, play_completion_sound: v })
                      }
                    />
                  </div>
                </div>
                <div className="settings-row">
                  ...
                  <div className="row-control">
                    <Toggle
                      ...
                      onChange={(v) =>
                        setConfig({ ...config, save_history: v })
                      }
                    />
                  </div>
                </div>
                    ...
                    <div className="row-control">
                      <select
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            max_history_entries: e.target.value
          ...
          <>
            ...
            {dictEntries.length === 0 ? (
              <div className="empty-state">
                ...
                <div className="empty-state-desc">
                  Add word substitutions applied after every transcription.
                  Matches whole words.
                </div>
              </div>
            ) : (
              ...
              <div className="permission-card">
                <div className="permission-header">
                  <div className="permission-title-row">
                    ...
                    <PermissionBadge
                      granted={microphone}
                      checking={checkingPerms}
                    />
                  </div>
                  <p className="permission-desc">
                    Allows Whisp to capture audio from your microphone for
                    transcription.
                  </p>
                </div>
                ...
                <p className="permission-footer">
                  Required — Whisp cannot record without microphone access.
                </p>
              </div>
            </div>
            ...
            <div className="section-group">
              ...
              <div className="permission-card">
                <div className="permission-header">
                  ...
                  <p className="permission-desc">
                    Required to detect global hotkey presses (via CGEventTap)
                    and inject transcribed text into other apps.
                  </p>
                </div>
                <div className="permission-actions">
                  <button
                ...
                <p className="permission-footer">
                  After granting access in System Settings, click Refresh —
                  macOS does not notify the app automatically.
                </p>
              </div>
            </div>
            ...
            <div className="section-group">
              ...
              <div className="permission-card">
                <div className="permission-header">
                  ...
                  <p className="permission-desc">
                    Monitors keyboard events globally to detect when your hotkey
                    is pressed.
                  </p>
                </div>
                <div className="permission-actions">
                ...
                <p className="permission-footer">
                  Required — without Input Monitoring, macOS may silently
                  disable the CGEventTap used to detect your hotkey.
                </p>
              </div>
            </div>
          </>
